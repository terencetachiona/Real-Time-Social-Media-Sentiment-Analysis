...
app.layout = html.Div(
    [   html.Div(className='container-fluid', children=[html.H2('Econet Real Time Twitter Sentiment', style={'color':"#CECECE"}),
                                                        html.H5('Search Econet Group Handles/Terms:', style={'color':app_colors['text']}),
                                                  dcc.Input(id='sentiment_term', value='econet', type='text', style={'color':app_colors['someothercolor']}),
                                                  ],
