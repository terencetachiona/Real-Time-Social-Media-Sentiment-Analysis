...
ckey="Y9C7M3j0u8C4lEH2OTNbWT6Y5"
csecret="80fMzm9a1fa9vIitymLOF4keBpZvNrKFd8DtuveWq9fohnMQsl"
atoken="732160585836703744-722RkSmFnCh6inE0AFX23MCNvozGVY6"
asecret="FFYYmQNSjH7OMPhZrWJ79dMjY1mITEZgeJhRpVT0UNo3k"
...
#conn.LoadExtension("System.Data.SQLite.dll", "sqlite3_fts5_init") #''/// Or "SQLite.Interop.dll" as you need.
...
def create_table():
    try:
        ...
        c.execute("PRAGMA compile_options=ENABLE_FTS5")
        ...
        c.execute("CREATE INDEX id_a_unix ON sentiment (id DESC, unix DESC)")
